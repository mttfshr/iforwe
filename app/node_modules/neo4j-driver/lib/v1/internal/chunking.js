...
var Chunker = function (_BaseBuffer) {
  ...
  (0, _createClass3.default)(Chunker, [{
    ...
    value: function putBytes(position, data) {
      // TODO: If data is larger than our chunk size or so, we're very likely better off just passing this buffer on id:68
      // rather than doing the copy here TODO: *however* note that we need some way to find out when the data has been id:77
